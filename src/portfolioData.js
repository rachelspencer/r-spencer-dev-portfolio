 const portfolioData = {
   //for Header.js
    name: "Rachel Spencer",
    headerLogo: "https://s24193.pcdn.co/wp-content/uploads/2016/07/entity-women-that-did-ada-lovelace-1320x720.jpg",
    //for Intro.js
    introPara: "A Frontend focused Web Developer building responsive applications, with a passion for crafting intuitive user interfaces and delivering seamless user experiences.",
    ...
    //for Contact.js
    contactPara: "Feel free to contact me by submitting the form below and I will get back to you as soon as possible.",
 };
