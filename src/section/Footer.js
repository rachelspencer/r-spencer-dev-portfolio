...
function Footer () {
    ...
    return (
        <footer className="flex flex-col opacity-95 bg-red-950 py-6 px-2 dark:bg-slate-900">
            <Panel>
            ...
            <Panel>
                ...
                <div className="flex justify-center py-6 px-2">
                    <div className="w-4 h-4 rounded-full bg-yellow-950 border border-white flex justify-center items-center dark:border-indigo-500 dark:bg-slate-900 ">
